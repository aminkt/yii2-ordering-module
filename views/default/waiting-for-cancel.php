...
$this->title = 'سفارشات در انتظار لغو';
                ...
                /** @var $model \aminkt\ordering\interfaces\OrderInterface */
                    ...
                    $html .= Html::a('<i class="fa fa-refresh"></i>',
                        [
                            ...
                            'container'=>'body',
                            'placement'=>'top',
                            'original-title'=>'بازگشت به در انتظار تائید'
                        ]]);
                    $html .= Html::a('<i class="fa fa-ban"></i>', [
                        'change-status',
                        'id'=>$model->getId(),
                        'page'=>$this->context->action->id,
                        'do'=>$model::STATUS_CANCELLED
                    ], ['class'=>'btn btn-icon-only red tooltips', 'data'=>[
                        'container'=>'body',
                        'placement'=>'top',
                        'original-title'=>'لغو سفارش',
                        'confirm'=>'از لغو این مورد اطمینان دارید؟',
                        'method'=>'post'
                    ]]);
                    $html .= '</div> </div>';
                    return $html;
