                ...
                'value' => function ($model) {
                    ...
                    $html .= Html::a('<i class="fa fa-check"></i>',
                        [
                            ...
                            'do'=>$model::STATUS_RECEIVED
                        ], ['class'=>'btn btn-icon-only green tooltips', 'data'=>[
                            'container'=>'body',
                            'placement'=>'top',
                            'original-title'=>'بایگانی سفارش',
                            'confirm'=>"آیا این سفارش توسط مشتری دریافت شد؟\n بعد از بایگانی امکان تغییر وضعیت سفارش وجود ندارد.",
                            'method'=>'post'
                        ]]);
                    $html .= Html::a('<i class="fa fa-refresh"></i>', [
                        ...
                        'id'=>$model->getId(),
                        'page'=>$this->context->action->id,
                        'do'=>$model::STATUS_RETURNED
                    ], ['class'=>'btn btn-icon-only yellow tooltips', 'data'=>[
                        'container'=>'body',
                        'placement'=>'top',
                        'original-title'=>'برگشت خوردن سفارش',
                        'confirm'=>'آیا این سفارش برگشت خورد؟',
                        'method'=>'post'
                    ]]);
                    $html .= '</div> </div>';
                    return $html;
